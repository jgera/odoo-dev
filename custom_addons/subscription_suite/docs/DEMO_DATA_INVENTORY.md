...
| Phase 8 | Security/access audit coverage for role and multi-company boundaries, medium-scale performance smoke data generated by tests/helpers, opt-in 10K benchmark data generated by script, then complete end-to-end demo story and release packaging |
