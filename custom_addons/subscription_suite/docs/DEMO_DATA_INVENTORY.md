...
| Phase 6 | MRR snapshots, reconciliation rows, movement anomalies, KPI summaries, KPI dashboards, and waterfalls are generated from current demo records; later add multi-month MRR movement history, cohorts, churn reasons, and forecast records |
