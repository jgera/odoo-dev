...
| Phase 6 | MRR snapshots, reconciliation rows, movement anomalies, KPI summaries, KPI dashboards, waterfalls, retention cohorts, revenue forecasts, ARPU summaries, LTV summaries, analytics smoke coverage, and generated-record lifecycle checks are generated from current or controlled records; later add multi-month MRR movement history and richer churn reasons |
