...
| Phase 7 | Deferred revenue schedules are generated from posted subscription invoices with valid service periods and required recognition configuration; ready/recognized schedules are locked for audit, mixed invoices should exclude one-time lines, and journal posting, reversals, credit-note adjustment examples, and finance reconciliation reports remain later Phase 7 targets |
