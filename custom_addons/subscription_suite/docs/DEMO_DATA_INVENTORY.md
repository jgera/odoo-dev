...
| Phase 8 | Security/access audit coverage, performance smoke/10K benchmark data generated by helpers, manager-only validated CSV migration and backfills, then complete end-to-end demo story and release packaging |
