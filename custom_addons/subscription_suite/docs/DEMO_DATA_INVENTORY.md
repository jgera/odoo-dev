...
Operational run summaries are generated by executing scheduled methods; they are not
loaded as static demo XML. For demonstrations, run billing, dunning, recognition, or
MRR snapshot processing against the documented demo subscriptions, then review
**Subscriptions -> Operations -> Operational Runs** and Manager Operations.
