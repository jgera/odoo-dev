...
| Phase 6 | MRR snapshots, reconciliation rows, movement anomalies, KPI summaries, KPI dashboards, waterfalls, and retention cohorts are generated from current demo records; later add multi-month MRR movement history, richer churn reasons, and forecast records |
