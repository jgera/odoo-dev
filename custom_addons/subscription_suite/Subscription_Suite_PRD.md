...
Deliver the most comprehensive open-source subscription management solution for Odoo 19 Community Edition, rivaling the capabilities of dedicated platforms like Chargebee, Recurly, and Stripe Billing — while maintaining deep, native Odoo integration.
...
class SaleOrder(models.Model):
    ...
    # Indexes defined via models.Constraint or init()
    def init(self):
        tools.create_index(
            self._cr,
